...
static struct gpio_keys_button A_PROJECT_keys[] = {
	...
	[3] = GPIO_IKEY(KEY_POWER, ENT_TPS80031_IRQ_BASE + TPS80031_INT_PWRON, 1, 1000),
 };
...
static void __init enterprise_uart_init(void)
{
	...
	if (board_id >= PROJECT_PHASE_XC) {
		enterprise_bt_uart_pdata.uart_bt = (1 == 1);
	}
	else {
		enterprise_bt_uart_pdata.uart_bt = (1 == 0);
	}
	...
	platform_add_devices(enterprise_uart_devices, ARRAY_SIZE(enterprise_uart_devices));
}
...
struct tegra_touchscreen_init __initdata synaptics_init_data = {
	.irq_gpio = TOUCH_GPIO_IRQ,
	.rst_gpio = TOUCH_GPIO_RST,
	.sv_gpio1 = {1, TOUCH_GPIO_RST, 0, 1},
	.sv_gpio2 = {1, TOUCH_GPIO_RST, 1, 100},
	.ts_boardinfo = {1, synaptics_i2c_info, 1}
};
...
struct tegra_touchscreen_init __initdata synaptics_init_data_XB = {
	...
	.sv_gpio1 = {1, TOUCH_GPIO_RST, 0, 1},
	.sv_gpio2 = {1, TOUCH_GPIO_RST, 1, 100},
	.ts_boardinfo = {1, synaptics_i2c_info_XB, 1}
};
